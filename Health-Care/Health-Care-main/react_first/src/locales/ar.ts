...
landing: {
  heroTitle: "التشخيص الطبي الذكي ودعم اتخاذ القرارات السريرية",
  heroSubtitle:
    "رؤى صحية ذكية لمتابعة حالتك الصحية بثقة ",
  ...
  heroCard1Title: "خطر الإصابة بالسكري",
  heroCard1Desc:
    "قيّم مؤشرات خطر السكري من خلال إدخال بيانات صحية بسيطة ومنظمة.",

  heroCard2Title: "خطر القلب والأوعية الدموية",
  heroCard2Desc:
    "تابع مؤشرات صحة القلب والأوعية الدموية لدعم الوعي المبكر بالمخاطر.",

  heroCard3Title: "مراجعة الطبيب",
  heroCard3Desc:
    "تقارير منظمة تساعد الطبيب على مراجعة الحالة ومتابعة المريض بكفاءة.",

  ctaHealthTitle: "تحكم في صحة السكري والقلب والأوعية الدموية",
  ctaHealthSubtitle:
    "ابدأ بتقييم بسيط يساعدك على فهم مؤشرات السكري وصحة القلب بشكل أوضح.",
  startDiagnosisNow: "ابدأ التشخيص الآن",

  howItWorksTitle: "كيف يعمل",
  howItWorksSubtitle:
    "عملية بسيطة من ثلاث خطوات للحصول على تقريرك الصحي المخصص.",
  step1Title: "1. أدخل البيانات الصحية",
  step1Desc:
    "أدخل بياناتك الصحية الأساسية من خلال واجهة سهلة ومنظمة.",
  step2Title: "2. تحليل ذكي للبيانات",
  step2Desc:
    "يقوم النظام بتحليل المدخلات لتقييم مؤشرات السكري والقلب والأوعية الدموية.",
  step3Title: "3. تقرير مخصص",
  step3Desc:
    "استلم تقريرًا واضحًا يتضمن النتائج والمؤشرات الصحية والتوصيات المناسبة.",

  benefitsTitle: "المميزات الرئيسية",
  benefitsSubtitle:
    "منصة طبية تساعد المرضى والأطباء على متابعة المؤشرات الصحية بطريقة سهلة وآمنة.",
  benefit1Title: "نتائج سريعة وواضحة",
  benefit1Desc: "احصل على تقييم صحي منظم خلال دقائق.",
  ...
  benefit4Title: "يدعم أكثر من تقييم",
  benefit4Desc: "يدعم تقييم السكري ومخاطر القلب والأوعية الدموية.",
  benefit5Title: "متاح في أي وقت",
  benefit5Desc: "استخدم الخدمة في أي وقت ومن أي مكان.",
  benefit6Title: "مناسب للمتابعة الطبية",
  benefit6Desc: "تقارير منظمة تساعد الطبيب على مراجعة الحالة.",

  ctaTitle: "تحكم في صحتك من اليوم.",
  ctaSubtitle:
    "ابدأ تقييمك الصحي واتخذ قرارات أوضح بناءً على مؤشرات منظمة.",
